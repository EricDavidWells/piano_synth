...
midifilename = 'porz_goret.mid'
outputfilename = 'porz_goret.csv'
...
# open a midi file
mid = MidiFile(r'piano_synth\data\MidiFiles' + '\\' + midifilename)
...
with open(r'piano_synth\data\NoteFiles' + '\\' + outputfilename, 'w', newline='') as csvfile:
